...
public class SerialPortPreferencesActivity extends PreferenceActivity {

	private MassageApplication mApplication;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mApplication = (MassageApplication) getApplication();
